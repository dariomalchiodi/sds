...
heroes = heroes.loc[heroes['Gender'] == 'F']
...
publisher_samples = [get_sample(heroes, 'Publisher', n)
...
Paragrafo @sec:stimatori-e-stime che questo è solo uno dei
...
e vedremo nel {numref}`Paragrafo %s <sec:media-campionaria>` che questa
...
Paragrafo @sec:il-campione, possiamo evidenziare questo fatto
...
all'inizio del Paragrafo @sec:il-campione, pertanto potrebbe
