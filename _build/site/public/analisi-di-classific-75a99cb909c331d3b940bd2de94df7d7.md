...
$(1 - \mathrm{specificità}, \mathrm{sensibilità})$ sul piano cartesiano. In
...
$(1-\mathrm{specificità}, \mathrm{sensibilità}) = (1, 1)$.
...
intervallo $[\theta_\min, \theta_\max]$ in cui il valore può variare, si può
...
$D = \{ \theta_0 = \theta_\min, \dots, \theta_n = \theta_\max \}$. Per ogni
