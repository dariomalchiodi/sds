...
- L'_intersezione_ di due insiemi $S$ e $T$ (vedi @venn-intersection)
...
- La _differenza_ tra un insieme $S$ e un insieme $T$ (vedi
  @venn-difference) è costituita dall'insieme $S \backslash T$
...
- La _differenza simmetrica_ tra due insiemi $S$ e $T$ (vedi
  @venn-symm-difference) è costituita dall'insieme $S \ominus T$
...
- Il _complemento_ di un insieme $S$ è costituito dall'insieme $\overline S$
  (vedi @venn-complement) contenente tutti gli elementi dell'insieme
