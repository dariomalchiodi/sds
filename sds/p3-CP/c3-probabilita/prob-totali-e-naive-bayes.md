...
$$ \mathbb E(X) \leq \int_0^a x f(x) \mathrm d x
                \leq a \int_0^a f(x) \mathrm d x = a \mathbb P(X \leq a). $$
...
$$ \mathbb P(| X - \mu | \leq \epsilon) \geq \frac{\sigma^2}{\epsilon^2}. $$
...
traslitterazione, io ho preferito fare riferimento allo standard
[ISO 9](https://it.wikipedia.org/wiki/Traslitterazione_scientifica_del_cirillico)
e adottare Čebyšëv.